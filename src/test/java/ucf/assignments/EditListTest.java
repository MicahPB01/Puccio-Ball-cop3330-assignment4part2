...
class EditListTest {
    ...
    void checkGetInfo() throws IOException {
        ...
        file.createNewFile();
        ItemObject testItem = new ItemObject("Test", "Test", "2000/10/10", "Incomplete");
    ...
    void checkGetCompletedInfo() throws IOException {
        ...
        ItemObject testItem1 = new ItemObject("Test1", "Test", "2000/10/10", "Incomplete");
        ItemObject testItem2 = new ItemObject("Test2", "Test", "2000/10/10", "Incomplete");
